...
Route::group('admin', [
    ...
    'pddGoodsSearch$'=>'admin/Goods/pddGoodsSearch',
    'importGoodsInfo'=>'admin/Goods/importGoodsInfo',

    'loginDuo$'=>'admin/Duo/loginDuo',
    'getDuoMessageCode'=>'admin/Duo/getDuoMessageCode',
    'goodsList' =>  'admin/Goods/goodsList',
    'missionAssign$' =>  'admin/Goods/missionAssign',
    'getGoodsPlan$'  =>  'admin/Goods/getGoodsPlan',
    'goodsPlan$'     =>  'admin/Goods/goodsPlan',
    'contact$'       =>  'admin/Goods/contact',
 ...
 */
Route::group('pdd',[
    'pddResponse'   => 'admin/Duo/auth'
])->middleware(app\admin\middleware\CheckAuth::class)->ext('');
/*****
 * 员工界面路由
 */
